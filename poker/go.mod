module vctt94/poker-bot/poker

go 1.21.0

require (
	github.com/chehsunliu/poker v0.1.0
	github.com/companyzero/bisonrelay v0.1.9
	github.com/decred/slog v1.2.0
	github.com/jrick/logrotate v1.0.0
	gopkg.in/yaml.v2 v2.4.0
	vctt94/poker-bot/bot v0.0.0-00010101000000-000000000000
)
...
replace vctt94/poker-bot/bot => ../bot
